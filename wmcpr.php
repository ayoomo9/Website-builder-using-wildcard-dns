...
echo "You tried to ban a vital member of wapbies so you are reverse punished!!";
  ...
  exit();
	...
	if($who==10 || $who==182 || $who==194 || isadmin($who) || isowner($who) || $who==16)
...
if($npl<0)
{
  ...
  if(trim($pres)=="")
  {
    ...
    $res = mysql_query("UPDATE gyd_users SET lastplreas='".mysql_real_escape_string($pres)."', plusses='".$npl."' WHERE id='".$who."'");
    if($res)
          {
